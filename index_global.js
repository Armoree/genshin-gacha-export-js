(async function () {
    ...
    const GachaTypesUrl = `//hk4e-api-os.mihoyo.com/event/gacha_info/api/getConfigList?${
        zhsearch.split("?")[1]
    }`;
    const GachaLogBaseUrl = `//hk4e-api-os.mihoyo.com/event/gacha_info/api/getGachaLog?${
        zhsearch.split("?")[1]
    }`;
